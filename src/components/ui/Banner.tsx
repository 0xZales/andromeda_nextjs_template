...
const Banner: FC<BannerProps> = ({ children }) => {
  return (
    <div className={`rounded-lg  bg-[#fffaf3]   container relative bg-theme flex flex-col   bg-[url('../../public/images/vectors/single-banner-wave-1.svg')] items-center justify-center p-24 `}>
      {children}
